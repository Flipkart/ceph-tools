...
if __name__ == '__main__':
    ...
    scrubber = UserScrubber(cluster_name, user_name, num_buckets_to_process_parallelly, total_threads, bucket_data_pool, bucket_data_cache_pool, conf_file_path, output_file_name_format)
    scrubber.run()
