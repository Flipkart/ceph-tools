...
PREV_ITERATION_BUCKET_NAME = None
PREV_ITERATION_OBJECT_NAME = None
...
def get_objects(bucket_name, max_objects, keys_per_query, marker = ""):
    bucket = cluster_util.get_bucket(bucket_name)
    object_list = []
...
def extract_all_objects(buckets):
    ...
    for bucket in buckets:
        ...
        objects = get_objects(bucket, 999999999, 50000)
